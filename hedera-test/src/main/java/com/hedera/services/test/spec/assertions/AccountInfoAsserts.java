package com.hedera.services.test.spec.assertions;
...
public class AccountInfoAsserts extends com.hedera.services.test.spec.assertions.BaseErroringAssertsProvider<AccountInfo> {
	...
	public AccountInfoAsserts solidityId(String cid) {
		registerProvider((spec, o) -> {
			...
			String solidityId = asSolidityAddress(0, id.getRealmNum(), id.getAccountNum());
	...
	private static String asSolidityAddress(int shard, long realm, long num) {
		...
		return Hex.encodeHexString(solidityAddress);
	}
