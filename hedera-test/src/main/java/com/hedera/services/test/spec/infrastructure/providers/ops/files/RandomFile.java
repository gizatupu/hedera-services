package com.hedera.services.test.spec.infrastructure.providers.ops.files;
...
import com.hedera.services.test.spec.keys.KeyShape;
import com.hedera.services.test.spec.utilops.UtilVerbs;
import com.hederahashgraph.api.proto.java.FileID;
import com.hederahashgraph.api.proto.java.Key;
import com.hederahashgraph.api.proto.java.ResponseCodeEnum;

import static com.hedera.services.test.spec.keys.KeyShape.listOf;
...
public class RandomFile implements OpProvider {
	...
	public RandomFile(
			RegistrySourcedNameProvider<FileID> files
	) {
		this.files = files;
	}
