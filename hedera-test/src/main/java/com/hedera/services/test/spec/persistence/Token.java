package com.hedera.services.test.spec.persistence;
...
import com.hedera.services.test.spec.queries.HapiQueryOp;
import com.hedera.services.test.spec.queries.QueryVerbs;
...
import static com.hedera.services.test.spec.persistence.Account.UNSPECIFIED_MEMO;
import static com.hedera.services.test.spec.persistence.Entity.UNUSED_KEY;
import static com.hedera.services.test.spec.persistence.SpecKey.RegistryForms.asAdminKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.RegistryForms.asFreezeKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.RegistryForms.asKycKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.RegistryForms.asSupplyKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.RegistryForms.asWipeKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.adminKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.freezeKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.kycKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.supplyKeyFor;
import static com.hedera.services.test.spec.persistence.SpecKey.wipeKeyFor;
