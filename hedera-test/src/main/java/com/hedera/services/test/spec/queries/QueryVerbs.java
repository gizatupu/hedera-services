package com.hedera.services.test.spec.queries;
...
import com.hedera.services.test.spec.queries.consensus.HapiGetTopicInfo;
import com.hedera.services.test.spec.queries.meta.HapiGetVersionInfo;
...
import com.hedera.services.test.spec.queries.contract.HapiContractCallLocal;
import com.hedera.services.test.spec.queries.contract.HapiGetContractBytecode;
import com.hedera.services.test.spec.queries.contract.HapiGetContractInfo;
import com.hedera.services.test.spec.queries.contract.HapiGetContractRecords;
import com.hedera.services.test.spec.queries.crypto.HapiGetAccountBalance;
import com.hedera.services.test.spec.queries.crypto.HapiGetAccountInfo;
import com.hedera.services.test.spec.queries.crypto.HapiGetAccountRecords;
import com.hedera.services.test.spec.queries.file.HapiGetFileContents;
import com.hedera.services.test.spec.queries.file.HapiGetFileInfo;
import com.hedera.services.test.spec.queries.meta.HapiGetReceipt;
import com.hedera.services.test.spec.queries.meta.HapiGetTxnRecord;

import java.util.function.Function;
import java.util.function.Supplier;

import static com.hedera.services.test.spec.queries.contract.HapiContractCallLocal.fromDetails;
