...
import com.hedera.services.test.spec.persistence.Entity;
import com.hedera.services.test.spec.persistence.SkipNullRepresenter;
...
public class YamlHelper {
	private static final Logger log = LogManager.getLogger(YamlHelper.class);
